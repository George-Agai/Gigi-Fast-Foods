                ...
                <CartProvider>
                    <div className='Home' style={{ display: homeIsActive ? 'flex' : 'none' }}>
                        ...
                        <div className='navigation-buttons-div-container' >
                            <button className='softdrink-button' style={{ width: '130px', marginLeft: '5px', border: fastFoodButton ? '1px solid #8a2be2' : '1px solid  rgb(206, 200, 200)' , color: fastFoodButton ? '#8a2be2' : 'rgba(95, 86, 86, 1)', height: fastFoodButton ? '60px' : '50px'}} onClick={handleScrollToFastFoods}><div className='navigation-buttons-div' style={{ marginLeft: '-14px' }}><img src={burger} alt='fastfood' className='softdrink' /></div>&ensp;<p>Fast Food</p></button>
                            <button className='softdrink-button' style={{ border: mainMealsButton ? '1px solid #8a2be2' : '1px solid  rgb(206, 200, 200)', color: mainMealsButton ? '#8a2be2' : 'rgba(95, 86, 86, 1)', height: mainMealsButton ? '60px' : '50px'}} onClick={handleScrollToMainMeals}><div className='navigation-buttons-div'><img src={mainmeal} alt='mainmeal' className='softdrink' /></div>&ensp;<p>Meals</p></button>
                            <button className='softdrink-button' style={{ border: drinksButton ? '1px solid #8a2be2' : '1px solid  rgb(206, 200, 200)', color: drinksButton ? '#8a2be2' : 'rgba(95, 86, 86, 1)', height: drinksButton ? '60px' : '50px'}} onClick={handleScrollToDrinks}><div className='navigation-buttons-div'><img src={softdrink} alt='softdrink' className='softdrink' /></div>&ensp;<p>Drinks</p></button>
                        </div>
